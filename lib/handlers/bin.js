...
module.exports = Observable.extend({
  ...
  apiCreateBin: function (req, res, next) {
    ...
    var fileArr = JSON.parse(bin.javascript);

    bin.fileArr = fileArr;
    bin.javascript = _(fileArr).pluck("js").join("\n\n");
  ...
  templateFromBin: function (bin) {
    var template = utils.extract(bin, 'html', 'css', 'javascript', 'fileArr');

    'html css javascript fileArr'.split(' ').forEach(function (panel) {
